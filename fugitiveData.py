...
class Fugitive:
    ...
    def to_dict(self):
        return {
            ...
            'NCIC': self.ncic,
            'Scars & Marks': self.scars_and_marks,
            'Images': self.images,
            'Person Classification': self.person_classification,
            'Height Min': self.height_min,
            'Race': self.race,
            'Age Range': self.age_range,
            'Aliases': self.aliases,
            'Complexion': self.complexion,
            'U-ID': self.uid,
            'Eyes Raw': self.eyes_raw,
            'Languages': self.languages,
            'Locations:': self.locations,
            'Status': self.status,
            'Reward Max': self.reward_max,
            'Eyes': self.eyes,
            'Race Raw': self.race_raw,
            'Modified': self.modified,
            'URL': self.url,
            'Publication': self.publication,
            'Additional Info': self.additional_information,
            ...
            'Reward Text': self.reward_text,
            'Description': self.description,
            'Caution': self.caution,
            'Age Max': self.age_max,
            'Path': self.path,
            'Legal Names': self.legat_names,
            'Possible Countries': self.possible_countries,
            'Sex': self.sex,
            'Place of Birth': self.place_of_birth,
            'Dates of Birth Used': self.dates_of_birth_used,
            'Hair Raw': self.hair_raw,
            'Hair': self.hair,
            'Coordinates': self.coordinates,
            'Field Offices': self.field_offices,
            '@ID': self.at_id
        }
